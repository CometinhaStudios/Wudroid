...
marker = "WUDROID_012_LOCAL_MULTIPLAYER_TEST10"
...
for required in (marker, "WudroidLanVideoPreview()"):
    if required not in main:
        raise SystemExit("Test10 verification failed: " + required)

print("Wudroid 0.1.2 Local Multiplayer Test10 applied")
print("- H.264 1280x720 / 30 FPS / 4 Mbps")
