...
marker = "WUDROID_012_LOCAL_MULTIPLAYER_TEST12"
...
for required in (marker, "WudroidLanVideoPreview()"):
    if required not in main:
        raise SystemExit("Test12 verification failed: " + required)

print("Wudroid 0.1.2 Local Multiplayer Test12 applied")
print("- H.264 1280x720 / 60 FPS / 8 Mbps")
