...
if marker in screen and marker in activity:
    print("Wudroid right-edge Activity bridge Test5 already applied")
    raise SystemExit(0)
...
if fullscreen_anchor in activity:
    activity = activity.replace(fullscreen_anchor, fullscreen_replacement, 1)
elif "configureRightEdgeGestureExclusion()" not in activity:
...
print("Wudroid 0.1.1 Right-edge Activity Bridge Test5 applied")
